...
# v2gRootCA
openssl ecparam -genkey -name secp521r1 -out privateKeys/v2gRootCA.key 
openssl req -new -key privateKeys/v2gRootCA.key -config configs/v2gRootCACert.cnf -out csrs/v2gRootCA.csr
openssl x509 -req -in csrs/v2gRootCA.csr -extfile configs/v2gRootCACert.cnf -extensions ext -signkey privateKeys/v2gRootCA.key -sha256 -set_serial 12345 -out certs/v2gRootCACert.pem -days $validity_v2g_root_cert

# cpoSubCA1
openssl ecparam -genkey -name secp521r1 -out privateKeys/cpoSubCA1.key  
openssl req -new -key privateKeys/cpoSubCA1.key -config configs/cpoSubCA1Cert.cnf -out csrs/cpoSubCA1.csr
openssl x509 -req -in csrs/cpoSubCA1.csr -extfile configs/cpoSubCA1Cert.cnf -extensions ext -CA certs/v2gRootCACert.pem -CAkey privateKeys/v2gRootCA.key -set_serial 12345 -out certs/cpoSubCA1Cert.pem -days $validity_cpo_subca1_cert

# # cpoSubCA2
openssl ecparam -genkey -name secp521r1 -out privateKeys/cpoSubCA2.key
openssl req -new -key privateKeys/cpoSubCA2.key -config configs/cpoSubCA2Cert.cnf -out csrs/cpoSubCA2.csr
openssl x509 -req -in csrs/cpoSubCA2.csr -extfile configs/cpoSubCA2Cert.cnf -extensions ext -CA certs/cpoSubCA1Cert.pem -CAkey privateKeys/cpoSubCA1.key -set_serial 12345 -out certs/cpoSubCA2Cert.pem -days $validity_cpo_subca2_cert 

# seccCert
openssl ecparam -genkey -name secp521r1 -out privateKeys/secc.key 
openssl req -new -key privateKeys/secc.key -config configs/seccCert.cnf -out csrs/seccCert.csr
openssl x509 -req -in csrs/seccCert.csr -extfile configs/seccCert.cnf -extensions ext -CA certs/cpoSubCA2Cert.pem -CAkey privateKeys/cpoSubCA2.key -set_serial 12345 -out certs/seccCert.pem -days $validity_secc_cert 
